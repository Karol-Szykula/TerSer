...
const long ServerStatusPanel::ID_STATICTEXT4 = wxNewId();
//*)
...
ServerStatusPanel::ServerStatusPanel(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size,long style,  const wxString& name)
{
	...
	StaticBoxSizer1 = new wxStaticBoxSizer(wxVERTICAL, this, _("Server status"));
	...
	StaticBoxSizer2->Add(StaticText1, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 0);
	...
	StaticBoxSizer3->Add(StaticText2, 1, wxALL|wxALIGN_CENTER_VERTICAL, 0);
	...
	StaticBoxSizer4->Add(StaticText3, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 0);
