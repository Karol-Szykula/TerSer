...
ConnectionSettingsFrame::ConnectionSettingsFrame(wxWindow* parent,wxWindowID id)
{
	...
	StaticBoxSizer1 = new wxStaticBoxSizer(wxVERTICAL, Panel3, _("Time intervals"));
	BoxSizer3 = new wxBoxSizer(wxHORIZONTAL);
	StaticText7 = new wxStaticText(Panel3, ID_STATICTEXT7, _("Event repeat time [ms]"), wxDefaultPosition, wxSize(119,13), 0, _T("ID_STATICTEXT7"));
	BoxSizer3->Add(StaticText7, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	TextCtrl1 = new wxTextCtrl(Panel3, ID_TEXTCTRL2, _("-"), wxDefaultPosition, wxDefaultSize, wxTE_RIGHT, wxDefaultValidator, _T("ID_TEXTCTRL2"));
	...
	StaticText8 = new wxStaticText(Panel3, ID_STATICTEXT8, _("Command interval [ms]"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT8"));
	BoxSizer5->Add(StaticText8, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	TextCtrl2 = new wxTextCtrl(Panel3, ID_TEXTCTRL3, _("-"), wxDefaultPosition, wxDefaultSize, wxTE_RIGHT, wxDefaultValidator, _T("ID_TEXTCTRL3"));
	...
	StaticText9 = new wxStaticText(Panel3, ID_STATICTEXT9, _("Query response time [ms]"), wxDefaultPosition, wxSize(130,13), 0, _T("ID_STATICTEXT9"));
	BoxSizer6->Add(StaticText9, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	TextCtrl3 = new wxTextCtrl(Panel3, ID_TEXTCTRL4, _("-"), wxDefaultPosition, wxDefaultSize, wxTE_RIGHT, wxDefaultValidator, _T("ID_TEXTCTRL4"));
	BoxSizer6->Add(TextCtrl3, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	StaticBoxSizer1->Add(BoxSizer6, 1, wxALL|wxEXPAND, 0);
	BoxSizer2->Add(StaticBoxSizer1, 1, wxALL|wxALIGN_TOP, 0);
	...
	StaticBoxSizer3 = new wxStaticBoxSizer(wxVERTICAL, Panel6, _("Command template"));
	BoxSizer8 = new wxBoxSizer(wxHORIZONTAL);
	StaticText12 = new wxStaticText(Panel6, ID_STATICTEXT12, _("Command separator"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT12"));
	BoxSizer8->Add(StaticText12, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	TextCtrl4 = new wxTextCtrl(Panel6, ID_TEXTCTRL5, _("-"), wxDefaultPosition, wxDefaultSize, wxTE_RIGHT, wxDefaultValidator, _T("ID_TEXTCTRL5"));
	BoxSizer8->Add(TextCtrl4, 1, wxALL|wxALIGN_CENTER_VERTICAL, 5);
	StaticBoxSizer3->Add(BoxSizer8, 1, wxALL|wxEXPAND, 0);
	BoxSizer9 = new wxBoxSizer(wxHORIZONTAL);
	StaticText13 = new wxStaticText(Panel6, ID_STATICTEXT13, _("Set variable token"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT13"));
	BoxSizer9->Add(StaticText13, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	TextCtrl5 = new wxTextCtrl(Panel6, ID_TEXTCTRL6, _("-"), wxDefaultPosition, wxDefaultSize, wxTE_RIGHT, wxDefaultValidator, _T("ID_TEXTCTRL6"));
	BoxSizer9->Add(TextCtrl5, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	StaticBoxSizer3->Add(BoxSizer9, 1, wxALL|wxEXPAND, 0);
	BoxSizer10 = new wxBoxSizer(wxHORIZONTAL);
	StaticText14 = new wxStaticText(Panel6, ID_STATICTEXT14, _("Query variable token"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT14"));
	BoxSizer10->Add(StaticText14, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	TextCtrl6 = new wxTextCtrl(Panel6, ID_TEXTCTRL7, _("-"), wxDefaultPosition, wxDefaultSize, wxTE_RIGHT, wxDefaultValidator, _T("ID_TEXTCTRL7"));
	BoxSizer10->Add(TextCtrl6, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	StaticBoxSizer3->Add(BoxSizer10, 1, wxALL|wxEXPAND, 0);
	StaticBoxSizer4 = new wxStaticBoxSizer(wxHORIZONTAL, Panel6, _("Set variable example command:"));
	StaticText10 = new wxStaticText(Panel6, ID_STATICTEXT10, _("N/A"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE, _T("ID_STATICTEXT10"));
	StaticBoxSizer4->Add(StaticText10, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	StaticBoxSizer3->Add(StaticBoxSizer4, 1, wxALL|wxEXPAND, 0);
	StaticBoxSizer5 = new wxStaticBoxSizer(wxHORIZONTAL, Panel6, _("Query variable example command:"));
	StaticText11 = new wxStaticText(Panel6, ID_STATICTEXT11, _("N/A"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE, _T("ID_STATICTEXT11"));
	StaticBoxSizer5->Add(StaticText11, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	StaticBoxSizer3->Add(StaticBoxSizer5, 1, wxALL|wxEXPAND, 0);
	BoxSizer7->Add(StaticBoxSizer3, 1, wxALL|wxALIGN_TOP, 5);
	...
	Treebook1->AddPage(Panel3, _("Sever"), false);
	Treebook1->AddPage(Panel6, _("Data frame"), false);
