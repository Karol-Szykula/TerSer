...
ConnectionSettingsFrame::ConnectionSettingsFrame(wxWindow* parent,wxWindowID id)
{
	...
	BoxSizer2->Add(TextCtrl1, 1, wxALL|wxALIGN_CENTER_VERTICAL, 5);
	...
	BoxSizer3->Add(StaticText8, 1, wxALL|wxALIGN_CENTER_VERTICAL, 5);
	...
	BoxSizer3->Add(TextCtrl2, 1, wxALL|wxALIGN_CENTER_VERTICAL, 5);
	...
	BoxSizer5->Add(StaticText9, 1, wxALL|wxALIGN_CENTER_VERTICAL, 5);
	...
	BoxSizer5->Add(TextCtrl3, 1, wxALL|wxALIGN_CENTER_VERTICAL, 5);
