...
ConnectionSettingsFrame::ConnectionSettingsFrame(wxWindow* parent,wxWindowID id)
{
	...
	FlexGridSizer5->Add(StaticBoxSizer2, 1, wxALL|wxEXPAND, 6);
	...
	StaticText7 = new wxStaticText(Panel3, ID_STATICTEXT7, _("ID start token"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT7"));
	...
	StaticText8 = new wxStaticText(Panel3, ID_STATICTEXT8, _("ID end token"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT8"));
	...
	StaticText9 = new wxStaticText(Panel3, ID_STATICTEXT9, _("Parameters token"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT9"));
	...
	StaticText10 = new wxStaticText(Panel3, ID_STATICTEXT10, _("Querys token"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT10"));
	FlexGridSizer4->Add(StaticText10, 1, wxALL|wxEXPAND, 5);
	TextCtrl4 = new wxTextCtrl(Panel3, ID_TEXTCTRL5, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL5"));
	FlexGridSizer4->Add(TextCtrl4, 1, wxALL|wxEXPAND, 5);
	StaticText11 = new wxStaticText(Panel3, ID_STATICTEXT11, _("Command example"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT11"));
	FlexGridSizer4->Add(StaticText11, 1, wxALL|wxEXPAND, 5);
	TextCtrl5 = new wxTextCtrl(Panel3, ID_TEXTCTRL6, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_READONLY, wxDefaultValidator, _T("ID_TEXTCTRL6"));
	FlexGridSizer4->Add(TextCtrl5, 1, wxALL|wxEXPAND, 5);
	StaticBoxSizer1->Add(FlexGridSizer4, 1, wxALL|wxEXPAND, 0);
	FlexGridSizer1->Add(StaticBoxSizer1, 1, wxALL|wxEXPAND, 6);
